...
const aboutData = [
  ...
  },
  {
    ...
    info: [
      {
        title: 'LKS Prov Jember Cyber Security - 1st',
        stage: '2022 - 2023',
      },
      {
        title: 'LKS Prov Jatim Cyber Security',
        stage: '2022 - 2023',
      },
    ],
  },
  {
    ...
    info: [
      ...
      {
        title: 'Penetration Testing Diskominfo Jember',
        stage: '2022 - 2023',
      },
    ],
  },
...
const About = () => {
  ...
  <div className="h-full bg-primary/30 py-32 text-center xl:text-left">
    <Circles />
    {/* avatar img */}
    <motion.div variants={fadeIn('right', 0.2)} initial="hidden" animate="show" exit="hidden" className="hidden xl:flex absolute bottom-0 -left-[410px]">
      <Avatar />
    </motion.div>
    <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
      ...
      <motion.p variants={fadeIn('right', 0.4)} initial="hidden" animate="show" exit="hidden" className="max-w-[500px] mx-auto xl:mx-1 mb-6 xl:mb-12 px-2 xl:px-0">10 years ago, I began freelancing as a developer. Since then, I've done remote work for agencies, consulted for startups, and collaborated on digital products for bussiness consumer use.
      </motion.p>
      {/* counters */}
