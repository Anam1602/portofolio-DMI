    ...
    <div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
      <div className="text-center flex flex-col justify-center xl:pt-40 xl:text-left h-full container mx-auto">
        ...
        <motion.h1 variants={fadeIn('down', 0.2)} initial='hidden' animate='show' exit='hidden' className="h1">
          Saya Adalah <br /> Seorang <span className="text-accent">Web Developer</span>
        </motion.h1>
        {/* subtitle */}
        <motion.p variants={fadeIn('down', 0.3)} initial='hidden' animate='show' exit='hidden' className="max-w-sm xl:max-w-xl mx-auto xl:mx-0 mb-10 xl:mb-16">Nama saya Khoirul Anam saya seorang Web Developer dan Bug Hunter, Anda dapat melihat karya saya dengan meng-klik tombol di bawah.
        </motion.p>
        {/* btn */}
